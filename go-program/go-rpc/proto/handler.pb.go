...
var fileDescriptor_515968b8e1a22554 = []byte{
	...
	,
}
...
func (c *handlerClient) Execute(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Handler/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHandlerServer) Execute(ctx context.Context, req *Request) (*Response, error) {
...
func _Handler_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServer).Execute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Handler/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServer).Execute(ctx, req.(*Request))
	}
...
var _Handler_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Execute",
			Handler:    _Handler_Execute_Handler,
		},
	},
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Action) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintHandler(dAtA, i, uint64(len(m.Action)))
		i += copy(dAtA[i:], m.Action)
	}
	if len(m.Query) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintHandler(dAtA, i, uint64(len(m.Query)))
...
func (m *Response) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Code != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintHandler(dAtA, i, uint64(m.Code))
	}
	if len(m.Result) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintHandler(dAtA, i, uint64(len(m.Result)))
