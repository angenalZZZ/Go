...
> [安装开发工具 GoLand `官网`](https://www.jetbrains.com/go/download/other.html) 破解→ idea.lanyus.com 获取激活码,或者[无限重置试用期](https://zhile.io/); 或者→ www.jb51.net 搜索 Jetbrains 下载→ [www.gopojie.net](https://www.gopojie.net/app/pc-app/office-app/jetbrains)<br> - [配置Tools/File-Watchers导入`go fmt`,`goimports`,`golangci-lint`](https://github.com/angenalZZZ/doc/blob/master/config/goland_watchers.xml)
